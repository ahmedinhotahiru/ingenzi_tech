...
const Header3: React.FC<HeaderProps> = ({ headerData }) => {
        ...
        <div className="flex w-full flex-col lg:flex-row">
          ...
          >
            <ul className="mt-4 flex flex-col max-lg:mb-4 max-lg:gap-4 lg:mt-0 lg:flex-row lg:items-center">
              ...
              <li className="relative">
                <button
                  ...
                  className="dropdown-toggle hover:text-prime-blue-700 mr-auto flex items-center justify-between text-base font-medium text-gray-500 transition-all duration-500 hover:text-gray-900 lg:m-0 lg:mb-0 lg:mr-6 lg:text-left"
                >
                  Products
                  <svg
                    className="dropdown-active-rotate-180 ml-1.5 h-2 w-3"
                    width="10"
                    height="6"
                    viewBox="0 0 10 6"
                    fill="none"
                ...
                <div
                  ...
                  className="animate-fade open relative top-2 z-10 hidden min-w-full rounded-lg bg-white p-2 shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] md:min-w-[500px] lg:absolute lg:-left-20 lg:top-14 lg:min-w-[800px] lg:p-4 xl:p-8"
                >
                  <div className="flex flex-col sm:flex-row lg:justify-between">
                      ...
                      <li className="">
                        ...
                        >
                          ...
                          <div className="ml-4 w-4/5">
                            <h5 className="mb-1.5 text-base font-semibold text-gray-900">
                              Analytics
                              <span className="ml-4 mr-2 h-5 rounded-full bg-indigo-50 px-2.5 py-1 text-xs font-medium text-indigo-500">
                                New
                              </span>
                            </h5>
                            <p className="text-xs font-medium text-gray-400">
                    ...
                    <ul
                      className="text-sm text-gray-700 lg:w-1/2"
              ...
              <li className="relative">
                <div className="dropdown relative inline-flex">
                  <button
                    ...
                    className="dropdown-toggle hover:text-prime-blue-700 mb-2 mr-auto flex items-center justify-between text-center text-base font-medium text-gray-500 transition-all duration-500 hover:text-gray-900 max-lg:h-max lg:m-0 lg:mb-0 lg:mr-6 lg:text-left"
                  >
                    Features
                    <svg
                      className="dropdown-active-rotate-180 ml-1.5 h-2 w-3"
                  ...
                  <div
                    id="dropdown-feature"
                    className="dropdown-menu relative mt-2 hidden rounded-xl shadow-lg max-lg:-left-14 max-lg:top-4 max-lg:bg-white lg:absolute lg:top-full lg:w-72 lg:bg-white"
            ...
            <div className="flex flex-col justify-start max-lg:gap-4 lg:flex-1 lg:flex-row lg:items-center lg:justify-end">
              ...
              <button className="shadow-xs cursor-pointer rounded-full bg-indigo-600 px-6 py-3 text-center text-sm font-semibold text-white transition-all duration-500 hover:bg-indigo-700 lg:ml-5">
                Sign up{" "}
              </button>
            </div>
          </div>
