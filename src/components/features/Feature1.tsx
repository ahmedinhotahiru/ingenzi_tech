      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-col items-center justify-center gap-x-0 gap-y-6 max-md:mx-auto max-md:max-w-lg lg:mb-16 lg:flex-row lg:justify-between lg:gap-y-0">
          <div className="relative w-full text-center lg:w-2/4 lg:text-left">
            <h2 className="mx-auto max-w-max font-primary text-4xl font-bold leading-[3.25rem] text-gray-900 lg:mx-0 lg:mb-6 lg:max-w-md">
          ...
          <div className="relative w-full text-center lg:w-2/4 lg:text-left">
            ...
            <Link
              to="/"
              className="flex flex-row items-center justify-center gap-2 text-base font-semibold text-primary-var-600 hover:text-primary-var-700 lg:justify-start"
            >
              Button CTA
              <svg
                width="20"
