...
const Contact3: React.FC<ContactProps> = ({ contactDetails, submitted }) => {
  ...
  return (
    <section className="w-full bg-background">
      <div data-aos="fade-up" className="mx-auto max-w-screen-lg">
        <Title title="Contact" description="Get In Touch" />
        <div className="w-full items-center gap-8 md:flex">
          <div className="items-center justify-center gap-4 space-y-5 py-8 max-md:py-12 md:w-[400px]">
          ...
          <form
            className="space-y-6 rounded-2xl border px-10 py-8 md:w-full md:space-y-8 md:py-10"
